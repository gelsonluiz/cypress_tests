...
Cypress.Commands.add('cadastrarInfracao_CI_E', () => {
  context('Informa Tipo do Condutor', () => {
    ...
    cy.get('select[ng-model="data.entidade.tipoCondutor"]').select('Estrangeiro');
    ...
    cy.get('input[placeholder*="Informe no mínimo 5 letras"]')
    .eq(2)
    .type('Argentin{enter}');
    cy.wait(500);
